...
import com.example.igestamobile.utils.NotificationHelper;
import com.example.igestamobile.R;
import com.example.igestamobile.adapter.CondenaUnidade.CondenaUnidadeAdapter;
import com.example.igestamobile.data.api.Condena.CondenaApi;
import com.example.igestamobile.data.api.CondenaUnidade.CondenaUnidadeApi;
import com.example.igestamobile.data.api.Empresa.EmpresaApi;
import com.example.igestamobile.data.api.Client.MongoRetrofitClient;
import com.example.igestamobile.data.api.Registro.RegistroApi;
...
import com.example.igestamobile.data.model.Condena.CondenaModel;
...
import com.example.igestamobile.databinding.FragmentContagemBinding;
...
public class ContagemFragment extends Fragment implements CondenaUnidadeAdapter.OnCondenaSelectionListener {
    ...
    private FragmentContagemBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentContagemBinding.inflate(inflater, container, false);
                                        ...
                                        turnoApi.selecionarPorUnidadeEPeriodo(finalUnidadeId, inicio, termino).enqueue(new Callback<TurnoResponse>() {
                                            ...
                                            public void onResponse(Call<TurnoResponse> call, Response<TurnoResponse> response) {
                                                if (response.isSuccessful() && response.body() != null) {
                                                    ...
                                                    ContagemFragment.this.pendingCondenasList = listaParaPlanilha;
